...
class WechatServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton('mini_program', fn() => new \SimpleCMS\Wechat\Packages\MiniProgram());
    }
    ...
    protected function loadRoutes(): void
    {
        ...
        $router->post('/api/wechat/token/{code}', [MiniProgramController::class, 'token'])->where('code', '[^/]+')->name('plugins.wechat.token');
